"""
Django settings for falling_scene_43883 project.
...
ROOT_URLCONF = 'falling_scene_43883.urls'
...
WSGI_APPLICATION = 'falling_scene_43883.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_scene_43883 API",
    "DESCRIPTION": "API documentation for falling_scene_43883 App",
    "VERSION": "v1",
}
